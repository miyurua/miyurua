...
![My Skills](https://skillicons.dev/icons?i=react,spring,next,typescript,javascript,tailwindcss,redux,html,css,scss,nodejs,express,mongodb,mysql,graphql,python,java,swift,aws,docker,git,github,pytorch,vscode,postman,firebase,flask,kali,linux,gatsby,wordpress)
